...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://actions.zapier.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("AccessPointApiKeyHeader", new ApiKeyAuth("header", "X-API-Key"));
        authentications.put("AccessPointApiKeyQuery", new ApiKeyAuth("query", "api_key"));
        RetryingOAuth oauth = configuration != null ? setupOauth(configuration.clientId, configuration.clientSecret, null) : null;
        authentications.put("SessionAuth", new ApiKeyAuth("cookie", "nlasession"));
        ...
        if (configuration != null) {
            if (configuration.accessPointApiKeyHeader != null) {
                this.setAccessPointApiKeyHeader(configuration.accessPointApiKeyHeader);
            }
            if (configuration.accessPointApiKeyQuery != null) {
                this.setAccessPointApiKeyQuery(configuration.accessPointApiKeyQuery);
            }
            if (configuration.sessionAuth != null) {
                this.setSessionAuth(configuration.sessionAuth);
            }
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("AccessPointOAuth", oauth);
        return oauth;
    }

    public String getAccessPointApiKeyHeader() {
        return ((ApiKeyAuth) this.getAuthentication("AccessPointApiKeyHeader")).getApiKey();
    }

    public void setAccessPointApiKeyHeader(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("AccessPointApiKeyHeader")).setApiKey(apiKey);
    }

    public void setAccessPointApiKeyHeaderPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("AccessPointApiKeyHeader")).setApiKeyPrefix(prefix);
    }
    public String getAccessPointApiKeyQuery() {
        return ((ApiKeyAuth) this.getAuthentication("AccessPointApiKeyQuery")).getApiKey();
    }

    public void setAccessPointApiKeyQuery(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("AccessPointApiKeyQuery")).setApiKey(apiKey);
    }

    public void setAccessPointApiKeyQueryPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("AccessPointApiKeyQuery")).setApiKeyPrefix(prefix);
    }
    public String getSessionAuth() {
        return ((ApiKeyAuth) this.getAuthentication("SessionAuth")).getApiKey();
    }

    public void setSessionAuth(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("SessionAuth")).setApiKey(apiKey);
    }

    public void setSessionAuthPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("SessionAuth")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://actions.zapier.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g /oauth/token/)
     * @return An instance of OkHttpClient
     */
